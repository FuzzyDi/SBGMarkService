...
public class MarkOperationRequest {
    ...
    public void setMarkCode(String markCode) { this.markCode = markCode; }
    ...
    public void setFiscalDocId(Long fiscalDocId) { this.fiscalDocId = fiscalDocId; }

    public Long getFiscalSign() { return fiscalSign; }
    public void setFiscalSign(Long fiscalSign) { this.fiscalSign = fiscalSign; }
